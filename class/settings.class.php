...
/**
 * \file        class/settings.class.php
 * \ingroup     scaninvoices
 * \brief       This file is a CRUD class file for Settings (Create/Read/Update/Delete)
 */
...
class Settings extends CommonObject
{
	 ...
	 */
	public $table_element = 'scaninvoices_settings';
	...
	/**
	 * @var string String with name of icon for settings. Must be the part after the 'object_' into object_settings.png
	 */
	...
	//  */
	// public $table_element_line = 'scaninvoices_settingsline';

	// /**
	//  * @var string    Field with ID of parent key if this object has a parent
	//  */
	// public $fk_element = 'fk_settings';

	// /**
	//  * @var string    Name of subtable class that manage subtable lines
	//  */
	// public $class_element_line = 'Settingsline';
	...
	//  */
	// protected $childtablesoncascade = array('scaninvoices_settingsdet');

	// /**
	//  * @var SettingsLine[]     Array of subtable lines
	//  */
	// public $lines = array();
	...
	public function __construct(DoliDB $db)
	{
		...
		// For backward compatibility with dolibarr < 18.0 (eldy) ... 17.0.2 for me (eric)
		...
		/*if ($user->rights->scaninvoices->settings->read) {
	...
	public function validate($user, $notrigger = 0)
	{
		...
		if (!empty($num)) {
			...
			if (!$error && !$notrigger) {
				// Call trigger
				$result = $this->call_trigger('SETTINGS_VALIDATE', $user);
				if ($result < 0) $error++;
				// End call triggers
			}
		}
	...
	public function setDraft($user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_DRAFT, $notrigger, 'SETTINGS_UNVALIDATE');
	}
	...
	public function cancel($user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_CANCELED, $notrigger, 'SETTINGS_CANCEL');
	}
	...
	public function reopen($user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_VALIDATED, $notrigger, 'SETTINGS_REOPEN');
	}
 ...
 */
class SettingsLine extends CommonObjectLine
{
	// To complete with content of an object SettingsLine
	// We should have a field rowid, fk_settings and position
